          ...
          <nav className="flex flex-wrap items-center">
            <Link className="flex items-center pr-10 mr-auto" href="/">
              <span className="relative w-10">
                <Image
                  className="text-light-01 bg-white fill-current dark:bg-dark-03"
              ...
              {menuItems &&
                menuItems.map((menuItem: any) => {
                  return (
                    ...
                    >
                      <Link
                        className="flex justify-center w-full p-3 text-dark-01 transition duration-200 ease-in-out rounded-corner-02 dark:text-light-02 hover:text-dark-04 hover:bg-light-04 dark:hover:text-dark-03 md:w-auto"
                        href={menuItem.url}
                      >
                        {menuItem.label}
                      </Link>
            ...
            >
              <div className="relative w-12 h-12 transition-colors duration-200 ease-in-out bg-black rounded-corner-02 hover:bg-dark-03">
                <svg
                  className={
